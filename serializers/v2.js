// This Grid version was introduced with the first edition of RCCService
// Generally has stayed the same throughout Roblox history (but we have little-to-no reference point for this, seeing as between 2008-2015 there is no RCCService versions available)
// However, based on the similarities, it is likely it barely changed

// 04/24/2008 (0.3.764.0) to 10/29/2017 (0.314.0.159032)
// Note that 07/29/2015 (0.206.0.62042) was the first version where the following operations were sighted:
// - OpenJobEx
// - CloseJobEx
// - ExecuteEx
// - BatchJobEx
